...
public class Monster {
    ...
    public Monster(int startX, int startY, String[] framePaths) {
        ...
        for (int i = 0; i < framePaths.length; i++) {
            this.frames[i] = new ImageIcon(Monster.class.getResource("/" + framePaths[i])).getImage();
        }
        this.lastUpdateTime = System.currentTimeMillis(); // Initialize timing
        this.damagedImage_right = new ImageIcon(Monster.class.getResource("/assets/enemies/bug/bug_damaged.png")).getImage();
        this.damagedImage_left = new ImageIcon(Monster.class.getResource("/assets/enemies/bug/bug_damaged_left.png")).getImage();
        this.monster1_dead = new ImageIcon(Monster.class.getResource("/assets/enemies/bug/monster1_death.png")).getImage();
    }
    /*
     * purpose:
     * pre:

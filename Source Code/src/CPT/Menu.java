...
public class Menu extends JFrame implements ActionListener {
  ...
  //set up for the map 1
    ...
    public void platforms_l1(){    	
    	...
    	platforms1.clear();
	    // platforms
        platforms1.add(new Platform(550, 780, 150, 30, "assets/platforms/floor1.png"));
        platforms1.add(new Platform(836, 722, 150, 30, "assets/platforms/floor1.png"));
        platforms1.add(new Platform(452, 488, 150, 30, "assets/platforms/floor1.png"));
        platforms1.add(new Platform(1151, 682, 150, 30, "assets/platforms/floor1.png"));
        platforms1.add(new Platform(1449, 599, 150, 30, "assets/platforms/floor1.png"));
        platforms1.add(new Platform(1200, 442, 150, 30, "assets/platforms/floor1.png"));
        platforms1.add(new Platform(1506, 267, 150, 30, "assets/platforms/floor1.png"));
        ...
        platforms1.add(new Platform(137, 913, 300, 30, "assets/platforms/bridge.png"));
        platforms1.add(new Platform(1563, 913, 300, 30, "assets/platforms/bridge.png"));
    }
    /*
    ...
    public void platforms_l2(){
    	...
    	gruzzer.add(new Gruzzer(616,594,1051,607,new String[]{"assets/enemies/gruzzer/gruzzer_1.png","assets/enemies/gruzzer/gruzzer_2.png"},knight));
    	gruzzer.add(new Gruzzer(1499,213,1788,626,new String[]{"assets/enemies/gruzzer/gruzzer_1.png","assets/enemies/gruzzer/gruzzer_2.png"},knight));
    	map2 = true;
    	monster.disappear();
    	monster2.disappear();
	    ...
	    // platforms
    	platforms1 = new ArrayList<>();
    	platforms1.add(new Platform(0, 404, 236, 604, "assets/platforms/block3.png"));
    	platforms1.add(new Platform(848, 170, 562, 300, "assets/platforms/block2.png"));
    	platforms1.add(new Platform(848, 706, 562, 300, "assets/platforms/block2.png"));
    	platforms1.add(new Platform(307, 578, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(314, 793, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(524, 813, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(551, 574, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(695, 711, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(633, 455, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(1578, 558, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(1661, 746, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(1751, 542, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(1557, 340, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(1805, 367, 200, 100, "assets/platforms/floor2.png"));
    	platforms1.add(new Platform(316, 398, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(526, 347, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(344,265, 128, 45, "assets/platforms/floor3.png"));
    	platforms1.add(new Platform(570,157, 128, 45, "assets/platforms/floor3.png"));
    ...
    private JPanel createGamePanel() {
        monster = new Monster(30, 830, new String[]{"assets/enemies/bug/bug1.png", "assets/enemies/bug/bug2.png", "assets/enemies/bug/bug3.png", "assets/enemies/bug/bug4.png"});
        monster2 = new Monster(1000, 830, new String[]{"assets/enemies/bug/bug1.png", "assets/enemies/bug/bug2.png", "assets/enemies/bug/bug3.png", "assets/enemies/bug/bug4.png"});
        ...
        backgroundImage1 = new ImageIcon(Menu.class.getResource("/assets/backgrounds/fb_1.jpg")).getImage();
        backgroundImage2 = new ImageIcon(Menu.class.getResource("/assets/backgrounds/fb_2.png")).getImage();
        backgroundImage3 = null; // fb3.png does not exist
        backgroundImage4 = new ImageIcon(Menu.class.getResource("/assets/backgrounds/Bigbossroom.jpg")).getImage();
        backgroundImage = backgroundImage1;
...
if (map2) {
    ...
    public JPanel createMainMenu() {
        IPanel mainMenu = new IPanel("assets/backgrounds/background.jpg");
        mainMenu.setLayout(null);

        ImageIcon nameIcon = new ImageIcon(Menu.class.getResource("/assets/ui/Nameqwq.png"));
    ...
    public JPanel createGifPanel() {
        ...
        ImageIcon gifIcon = new ImageIcon(Menu.class.getResource("/assets/ui/Hollow Knight.gif"));
    ...
    public void showControlPanel() {
        ...
        ImageIcon controlIcon = new ImageIcon(Menu.class.getResource("/assets/ui/control.png"));

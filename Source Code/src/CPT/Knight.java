...
public class Knight {
    ...
    // Cache: load each image only once instead of every frame
    private static final Map<String, Image> imageCache = new HashMap<>();
    private static Image loadImage(String path) {
        return imageCache.computeIfAbsent(path, p -> {
            java.net.URL url = Knight.class.getResource("/" + p);
            if (url == null) return new ImageIcon().getImage(); // missing file fallback
    ...
    private Image heartImage = loadImage("assets/knight/heart.png");// image for the heart
   ...
   // Slash effect variables
    ...
    public Image getSlashEffectImage() {
        ...
        if (isFacingLeft()) {
            ...
            imagePath = "assets/knight/slash" + (slashEffectFrame == 1 ? "1" : "2") + "_left_" + slashEffectFrame + ".png";
        } else {
            // Use "slash1_right" for the first frame, "slash2_right" for the second frame
            imagePath = "assets/knight/slash" + (slashEffectFrame == 1 ? "1" : "2") + "_right_" + slashEffectFrame + ".png";
        }
    ...
    // Preload all knight images at startup to avoid stutter during gameplay
    private static void preloadAllImages() {
        String[] dirs = {"left", "right"};
        // Walk frames
        for (String dir : dirs)
            for (int i = 1; i <= 4; i++) loadImage("assets/knight/walk_" + dir + "_" + i + ".png");
        // Dash frames
        for (String dir : dirs)
            for (int i = 1; i <= 8; i++) loadImage("assets/knight/dash_" + dir + "_" + i + ".png");
        // Slash character frames
        for (String dir : dirs)
            for (int i = 1; i <= 5; i++) loadImage("assets/knight/slash1_char_" + dir + "_" + i + ".png");
        // Slash effect frames
        loadImage("assets/knight/slash1_left_1.png");
        loadImage("assets/knight/slash1_right_1.png");
        loadImage("assets/knight/slash2_left_2.png");
        loadImage("assets/knight/slash2_right_2.png");
        // Death frames
        for (String dir : dirs)
            for (int i = 1; i <= 2; i++) loadImage("assets/knight/death_" + dir + "_" + i + ".png");
        // Other
        for (String dir : dirs) {
            loadImage("assets/knight/damage_shock_" + dir + ".png");
            loadImage("assets/knight/jump_" + dir + ".png");
            loadImage("assets/knight/fall_" + dir + ".png");
            loadImage("assets/knight/player_" + dir + ".png");
        }
        loadImage("assets/knight/heart.png");
    }
    ...
    */
    ...
    public Image getCurrentImage() {
        ...
        if (isDashing) {
            imagePath = dashLeft ? "assets/knight/dash_left_" + dashFrame + ".png" : "assets/knight/dash_right_" + dashFrame + ".png";
        }
        else if (isKnockedBack || isDamaged) {
            imagePath = lastDirectionLeft ? "assets/knight/damage_shock_left.png" : "assets/knight/damage_shock_right.png";
        }
        else if (isDamaged) {
            imagePath = lastDirectionLeft ? "assets/knight/damage_shock_left.png" : "assets/knight/damage_shock_right.png";
        }
        else if (isSlashing) {
            imagePath = lastDirectionLeft ? "assets/knight/slash1_char_left_" + slashFrame + ".png"
                    : "assets/knight/slash1_char_right_" + slashFrame + ".png";
        }else if (isDead) {
            imagePath = lastDirectionLeft ? "assets/knight/death_left_" + deathFrame + ".png"
                    : "assets/knight/death_right_" + deathFrame + ".png";
        }
        else if (isJumping || isFalling) {
            imagePath = isJumping ? (lastDirectionLeft ? "assets/knight/jump_left.png" : "assets/knight/jump_right.png")
                                  : (lastDirectionLeft ? "assets/knight/fall_left.png" : "assets/knight/fall_right.png");
        } else if (isMovingLeft) {
            imagePath = "assets/knight/walk_left_" + frame + ".png";}

        else if (isMovingRight) {
            imagePath = "assets/knight/walk_right_" + frame + ".png";
        } else {
            imagePath = lastDirectionLeft ? "assets/knight/player_left.png" : "assets/knight/player_right.png";
        }
        return loadImage(imagePath);
    }

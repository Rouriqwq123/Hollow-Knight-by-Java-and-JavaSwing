...
public class Gruzzer {
    ...
    public Gruzzer(int startX1, int startY1, int endX2, int endY2, String[] framePaths, Knight player) {
        ...
        for (int i = 0; i < framePaths.length; i++) {
            this.frames[i] = new ImageIcon(Gruzzer.class.getResource("/" + framePaths[i])).getImage();
        }
        this.damagedImage = new ImageIcon(Gruzzer.class.getResource("/assets/enemies/gruzzer/gruzzer_damaged.png")).getImage(); // Load damaged image
        this.deathImage = new ImageIcon(Gruzzer.class.getResource("/assets/enemies/gruzzer/gruzzer_corpse.png")).getImage(); // Load death image

...
public class Husk {
    ...
    public Husk(int startX1, int startY, int endX2, Knight knight) {
        ...
        walkLeftFrames = new Image[]{
            new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_left_1.png")).getImage(),
            new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_left_2.png")).getImage()
        };
        walkRightFrames = new Image[]{
            new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_right_1.png")).getImage(),
            new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_right_2.png")).getImage()
        };
        attackLeft = new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_attack_left.png")).getImage();
        attackRight = new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_attack_right.png")).getImage();
        damagedLeft = new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_left_damage.png")).getImage();
        damagedRight = new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_right_damage.png")).getImage();
        attackDamagedLeft = new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_attack_left_damage.png")).getImage();
        attackDamagedRight = new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_attack_right_damage.png")).getImage();
        deadLeft = new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_dead_left.png")).getImage();
        deadRight = new ImageIcon(Husk.class.getResource("/assets/enemies/husk/husk_dead_right.png")).getImage();
    }
